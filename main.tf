...
module "jenkins" {
  ...
  sg_for_jenkins            = [module.aws_security_group.sg_ec2_jenkins_port_8080, module.aws_security_group.sg_ec2_sg_ssh_http_id]
...
module "alb" {
  ...
  lb_type                   = "application"
  is_external               = false
  sg_enable_ssh_https       = module.aws_security_group.sg_ec2_sg_ssh_http_id
